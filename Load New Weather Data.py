...
# MAGIC %md #Other Stuff

# COMMAND ----------

# # Constants
# FILE_WEATHER_TMP='/dbfs/FileStore/shared_uploads/ram.senth@berkeley.edu/new_data/weather_files.txt'
# FILE_WEATHER_FINAL_FOLDER='/shared_uploads/ram.senth@berkeley.edu/new_data/weather/final/'
