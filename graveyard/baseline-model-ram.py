...
f = plt.figure()
my_suptitle = f.suptitle('ROC Curve (2018 Data)', fontsize=18, y=1.02) 
...
f = plt.figure()
my_suptitle = f.suptitle('fMeasure By Threshold (2018 Data)', fontsize=18, y=1.02) 
x_val = [x[0] for x in points]
y_val = [x[1] for x in points]
...
f = plt.figure()
my_suptitle = f.suptitle('Loss Curve (2015-2017 Data)', fontsize=18, y=1.02) 
...
# MAGIC 
# MAGIC Table 1: Model Performance (2018 Data)
